...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='listing',
            name='brand',
            field=models.CharField(choices=[('toyota', 'Toyota'), ('honda', 'Honda'), ('ford', 'Ford'), ('chevrolet', 'Chevrolet'), ('nissan', 'Nissan'), ('BMW', 'BMW'), ('mercedes-benz', 'Mercedes-Benz'), ('volkswagen', 'Volkswagen'), ('hyundai', 'Hyundai'), ('kia', 'Kia'), ('subaru', 'Subaru'), ('mazda', 'Mazda'), ('lexus', 'Lexus'), ('audi', 'Audi'), ('porsche', 'Porsche'), ('jaguar', 'Jaguar'), ('land rover', 'Land Rover'), ('volvo', 'Volvo'), ('tesla', 'Tesla'), ('mitsubishi', 'Mitsubishi')], default=None, max_length=24),
        ),
        migrations.AddField(
            model_name='listing',
            name='color',
